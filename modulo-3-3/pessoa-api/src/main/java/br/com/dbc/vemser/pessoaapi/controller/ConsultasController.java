...
public class ConsultasController {
    ...
    public ResponseEntity<List<EnderecoEntity>> findEnderecoByPais (@PathVariable("pais") String pais) {
        return new ResponseEntity<>(enderecoRepository.findEnderecoByPais(pais), OK);
    }

//    @GetMapping("/endereco/{idPessoa}")
//    public ResponseEntity<List<EnderecoEntity>> findEnderecoByIdPessoa (@PathVariable("idPessoa") Integer idPessoa) {
//        return new ResponseEntity<>(enderecoRepository.findEnderecoByIdPessoa(idPessoa), OK);
//    }
