...
SELECT MAX(ID_ENDERECO) AS QUANTIDADE_DE_ENDERECOS FROM VEM_SER.ENDERECO;

SELECT COUNT(ID_ENDERECO) AS QUANT_ENDER_CIDADE FROM VEM_SER.ENDERECO GROUP BY ID_CIDADE; 
