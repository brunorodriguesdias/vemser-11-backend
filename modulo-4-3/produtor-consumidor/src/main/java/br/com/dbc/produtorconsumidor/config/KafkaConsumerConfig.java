...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> listenerContainerFactory(){
        ...
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, clientId); // kafka.client-id=meu-consumidor
        props.put(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, 10); // quantidade de linhas por vez lida
